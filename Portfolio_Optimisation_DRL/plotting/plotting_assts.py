...
if "alle" in drawlist:
    ...
    ax.legend()
    plt.savefig('learning_curves_episode_assets.png')
...
if "ppo" in drawlist:
    ...
    ax.legend()
    plt.savefig('learning_curves_episode_ppo_assets.png')
...
if "a2c" in drawlist:
    ...
    ax.legend()
    plt.savefig('learning_curves_episode_a2c_assets.png')
...
if "sac" in drawlist:
    ...
    ax.legend()
    plt.savefig('learning_curves_episode_sac_assets.png')
