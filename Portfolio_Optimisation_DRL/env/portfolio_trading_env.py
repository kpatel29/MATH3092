...
# trading fee:  min 2 USD/deal  0.03 USD/stock
...
class PortfolioTradingEnv(gym.Env):
    ...
    def __init__(self, portfolio_stocks, initial_cash, start_day, end_day, out_csv_name='results/rewards', verbose=False):
        ...
        self.stocks_history = pd.read_csv("C:/Users/kiero/Documents/MATH3092 Project 30685729/Portfolio_Optimisation_DRL/data/prices-split-adjusted.csv")
    ...
    def _compute_step_info(self):
        return {
            ...
            'AAPL': self.account['AAPL'],
            'AMZN': self.account['AMZN'],
            'GOOGL': self.account['GOOGL'],
            'NFLX': self.account['NFLX']
        }
